...
const contact = {
  ...
  phone: "+92 304 4819330",
  linkedIn: "https://linkedin.com/in/irfanadot",
...
export const portfolio = {
  ...
  expertise: [
    ...
    },
    {
      ...
      skills: ["LLM integration", "n8n automation", "AI agents and agentic workflows"],
    },
    {
      title: "Mobile Engineering",
      description: "Ship maintainable mobile products across platforms.",
      skills: ["Flutter and Dart", "Native Android", "Native iOS"],
    },
    {
  ...
  caseStudies: [
    {
      ...
      approach: [
        ...
        "Law 25, PIPEDA, and Bill 16/141 requirements are treated as cross-cutting and shape resident and financial data handling throughout the system, not bolted on afterward.",
      ],
      technologies: [
        "Node.js",
        "Express.js",
    ...
    },
    {
      ...
      responsibilities: [
        ...
        "Own the backend and API architecture behind the counter app and shop management workflows, and release readiness.",
        "Set the implementation approach for digital Khata credit tracking, serial number tracking for warranty verification, and automated installment plan scheduling.",
    ...
    },
    {
      ...
      approach: [
        "Flutter application architecture and state management patterns established so new quest and content types could be added without touching the core.",
        "Cross-platform offline and online data sync designed to keep the app reliable for a large, globally distributed user base.",
        "Real-time messaging layer built to support the platform's premium training content and community updates.",
        "Release support, crash analysis, and continuous performance work kept the app stable as the user base grew past 100,000.",
      ],
      technologies: [
        "Flutter",
        "Dart",
